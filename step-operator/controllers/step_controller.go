...
import (
	...
	v1 "github.com/programming-kubernetes/cnat/step-operator/api/v1"
	webappv1 "github.com/programming-kubernetes/cnat/step-operator/api/v1"
)
...
// +kubebuilder:rbac:groups=webapp.infracloud.io,resources=steps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.infracloud.io,resources=steps/status,verbs=get;update;patch

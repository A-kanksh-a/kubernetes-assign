...
type StepSpec struct {
	...
	// PodNamespace is an example field of Step. Edit Step_types.go to remove/update
...
// +kubebuilder:printcolumn:JSONPath=".status.lastUpdate",name="LASTUPDATE",type="string"
